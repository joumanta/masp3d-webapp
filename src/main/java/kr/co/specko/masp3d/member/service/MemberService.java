...
public class MemberService {
    ...
    public void save(User user, List<String> files) {
        Company company = user.getCompany();
        company.setFile1(files.get(0));
        company.setFile2(files.get(1));
        company.setFile3(files.get(2));
        company.setFile4(files.get(3));
        company.setFile5(files.get(4));
